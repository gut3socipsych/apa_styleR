...
A single sampel t-test was conducted to compare the mean circumference of the sample orange trees to the population parameter (mu = 80). The test revealed, `r example_1@text`, that the sample mean was significantly different from the population. 
